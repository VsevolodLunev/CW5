...
def create_data_base(database_name, params) -> None:
    ...
    with psycopg2.connect(dbname=database_name, **params) as conn:
        with conn.cursor() as cur:
            ...
            CONSTRAINT pk_companies_company_name PRIMARY KEY (company_name));
            )
            """)
            ...
            with conn.cursor() as cur:
                ...
                ALTER TABLE vacancies ADD CONSTRAINT fk_vacancies_companies FOREIGN KEY(company_name)
...
def save_data_to_db(data, database_name, params) -> None:
    ...
    insert_q = """
        ...
        """
    insert_q_2 = """
        INSERT INTO companies (company_id, company_name, company_url) VALUSES (%s, %s, %s)
        """
    with psycopg2.connect(dbname=database_name, **params) as conn:
        with conn.cursor() as cur:
            for vacancy in data:
